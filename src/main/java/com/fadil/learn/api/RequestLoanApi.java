...
public interface RequestLoanApi {
    ...
    ResponseEntity<Object> getLoanRequestActiveByUser(UserDTO userDTO);
    ...
    ResponseEntity<Object> getLoanRequestHistoryByUser(UserDTO userDTO);

    @Operation(summary = "Active loan request by manager", description = "fetches loan request by manager have active status (PENDING)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "successful operation")
    })
    ResponseEntity<Object> getLoanRequestActiveByManager(UserDTO userDTO);
    ...
    ResponseEntity<Object> getLoanRequestHistoryByManager(UserDTO userDTO);
